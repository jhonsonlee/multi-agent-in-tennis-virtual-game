...
EPS_INIT = 5.0          # initial value epsilon noise decay
EPS_DECAY_SCL = 0.8    # The scale of epsilon decay
EPS_END = 0.0           # the minimum decay
...
class Agent():
    def __init__(self, state_size, action_size, num_agents, random_seed):
        ...
        self.eps_decay = EPS_INIT
        self.eps_scl = EPS_DECAY_SCL
    ...
    def learn(self, experiences, gamma, agent_number):
        ...
        self.eps_decay *= self.eps_scl
        self.eps_decay = max(self.eps_decay, EPS_END)
    ...
    def act(self, states, add_noise=True):
        ...
        if add_noise:
            actions += self.eps_decay * self.noise.sample()
